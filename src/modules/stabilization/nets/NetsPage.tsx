...
function Sketch({ input }: { input: Input }) {
  ...
  return <svg className="beam-svg" viewBox="0 0 520 260" role="img" aria-label="Desenho Redes metálicas">
    ...
    <text x="82" y="42" fontWeight="700">🕸 Redes metálicas</text>
...
export function NetsPage() {
  ...
  return <section className="page">
    <div className="page-title"><h1>🕸 Redes metálicas</h1><span className={result.status.startsWith('Verifica') ? 'status ok' : 'status warning'}>{result.status}</span></div>
    <div className="workspace">
      <div className="workspace-main">
        <Card title="Dados">
          <p className="muted">Área, fixações e cabos para redes de proteção de taludes.</p>

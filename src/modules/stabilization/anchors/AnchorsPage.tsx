...
function Sketch({ input }: { input: Input }) {
  ...
  return <svg className="beam-svg" viewBox="0 0 520 260" role="img" aria-label="Desenho Ancoragens">
    ...
    <text x="82" y="42" fontWeight="700">⚓ Ancoragens</text>
...
export function AnchorsPage() {
  ...
  return <section className="page">
    <div className="page-title"><h1>⚓ Ancoragens</h1><span className={result.status.startsWith('Verifica') ? 'status ok' : 'status warning'}>{result.status}</span></div>
    <div className="workspace">
      <div className="workspace-main">
        <Card title="Dados">
          <p className="muted">Pré-dimensionamento de ancoragens ativas/passivas com bolbo e comprimento livre.</p>
      ...
      <aside className="result-panel">
        ...
        <p>carga serviço: <strong>{result.quantity.toFixed(2)} kN</strong></p>

...
function Sketch({ input }: { input: Input }) {
  ...
  return <svg className="beam-svg" viewBox="0 0 520 260" role="img" aria-label="Desenho Máscaras drenantes">
    ...
    <text x="82" y="42" fontWeight="700">💧 Máscaras drenantes</text>
    <text x="82" y="244">H={input.height} m · L={input.length} m</text>
  </svg>;
}

export function DrainageMasksPage() {
  ...
  return <section className="page">
    <div className="page-title"><h1>💧 Máscaras drenantes</h1><span className={result.status.startsWith('Verifica') ? 'status ok' : 'status warning'}>{result.status}</span></div>
    <div className="workspace">
      <div className="workspace-main">
        <Card title="Dados">
          <p className="muted">Dimensionamento preliminar de máscara drenante com geotêxtil, brita e tubo.</p>
      ...
      <aside className="result-panel">
        ...
        <p>caudal: <strong>{result.quantity.toFixed(2)} l/s</strong></p>

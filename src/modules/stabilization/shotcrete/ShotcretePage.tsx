...
function Sketch({ input }: { input: Input }) {
  ...
  return <svg className="beam-svg" viewBox="0 0 520 260" role="img" aria-label="Desenho Betão projetado">
    ...
    <text x="82" y="42" fontWeight="700">🧱 Betão projetado</text>
...
export function ShotcretePage() {
  ...
  return <section className="page">
    <div className="page-title"><h1>🧱 Betão projetado</h1><span className={result.status.startsWith('Verifica') ? 'status ok' : 'status warning'}>{result.status}</span></div>
    <div className="workspace">
      <div className="workspace-main">
        <Card title="Dados">
          <p className="muted">Estimativa de volume, consumo e camada de betão projetado.</p>
      ...
      <aside className="result-panel">
        ...
        <p>espessura: <strong>{result.quantity.toFixed(2)} cm</strong></p>

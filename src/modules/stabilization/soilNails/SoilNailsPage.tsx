...
function Sketch({ input }: { input: Input }) {
  ...
  return <svg className="beam-svg" viewBox="0 0 520 260" role="img" aria-label="Desenho Pregagens">
    ...
    <text x="82" y="42" fontWeight="700">🔩 Pregagens</text>
...
export function SoilNailsPage() {
  ...
  return <section className="page">
    <div className="page-title"><h1>🔩 Pregagens</h1><span className={result.status.startsWith('Verifica') ? 'status ok' : 'status warning'}>{result.status}</span></div>
    <div className="workspace">
      <div className="workspace-main">
        <Card title="Dados">
          <p className="muted">Verifica aderência e capacidade preliminar de pregagens em taludes.</p>

...
function Sketch({ input }: { input: Input }) {
  ...
  return <svg className="beam-svg" viewBox="0 0 520 260" role="img" aria-label="Desenho Drenos horizontais">
    ...
    <text x="82" y="42" fontWeight="700">🌊 Drenos horizontais</text>
    <text x="82" y="244">H={input.height} m · L={input.length} m</text>
  </svg>;
}

export function HorizontalDrainsPage() {
  ...
  return <section className="page">
    <div className="page-title"><h1>🌊 Drenos horizontais</h1><span className={result.status.startsWith('Verifica') ? 'status ok' : 'status warning'}>{result.status}</span></div>
    <div className="workspace">
      <div className="workspace-main">
        <Card title="Dados">
          <p className="muted">Estimativa de malha e caudal de drenos horizontais em taludes.</p>
      ...
      <aside className="result-panel">
        ...
        <p>comprimento: <strong>{result.quantity.toFixed(2)} m</strong></p>

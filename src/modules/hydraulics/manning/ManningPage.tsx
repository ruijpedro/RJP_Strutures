...
export function ManningPage() {
  ...
  return <main className="page"><div className="page-title"><h1>Manning</h1><span className={`status ${velocityClass === 'Elevada' ? 'warning' : 'ok'}`}>{velocityClass}</span></div>
    <div className="workspace"><div className="workspace-main">
      <Card title="Dados"><p>Calculadora direta de Manning para estudo académico e apoio preliminar.</p><div className="form-grid">
      ...
      <Card title="Desenho hidráulico"><HydraulicCanvas title="Manning" result={result} mode="channel" /></Card>

...
export function HydraulicsLibraryPage() {
  ...
  return <main className="page"><div className="page-title"><h1>Biblioteca hidráulica</h1><span className={`status ${velocityClass === 'Elevada' ? 'warning' : 'ok'}`}>{velocityClass}</span></div>
    <div className="workspace"><div className="workspace-main">
      <Card title="Dados"><p>Valores de referência de rugosidade e notas de utilização.</p><div className="form-grid">
      ...
      <Card title="Desenho hidráulico"><HydraulicCanvas title="Biblioteca hidráulica" result={result} mode="drain" /></Card>

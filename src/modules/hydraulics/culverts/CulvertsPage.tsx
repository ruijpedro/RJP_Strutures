...
export function CulvertsPage() {
  ...
  return <main className="page"><div className="page-title"><h1>Passagens hidráulicas</h1><span className={`status ${velocityClass === 'Elevada' ? 'warning' : 'ok'}`}>{velocityClass}</span></div>
    <div className="workspace"><div className="workspace-main">
      <Card title="Dados"><p>Pré-dimensionamento simplificado de secção hidráulica com controlo por caudal e velocidade.</p><div className="form-grid">
      ...
      <Card title="Desenho hidráulico"><HydraulicCanvas title="Passagens hidráulicas" result={result} mode="culvert" /></Card>

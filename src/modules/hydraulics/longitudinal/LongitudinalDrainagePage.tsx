...
export function LongitudinalDrainagePage() {
  ...
  return <main className="page"><div className="page-title"><h1>Drenagem longitudinal</h1><span className={`status ${velocityClass === 'Elevada' ? 'warning' : 'ok'}`}>{velocityClass}</span></div>
    <div className="workspace"><div className="workspace-main">
      <Card title="Dados"><p>Dimensionamento preliminar de valetas e caleiras ao longo de plataformas.</p><div className="form-grid">
      ...
      <Card title="Desenho hidráulico"><HydraulicCanvas title="Drenagem longitudinal" result={result} mode="channel" /></Card>

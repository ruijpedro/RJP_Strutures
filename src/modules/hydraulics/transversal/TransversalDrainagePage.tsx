...
export function TransversalDrainagePage() {
  ...
  return <main className="page"><div className="page-title"><h1>Drenagem transversal</h1><span className={`status ${velocityClass === 'Elevada' ? 'warning' : 'ok'}`}>{velocityClass}</span></div>
    <div className="workspace"><div className="workspace-main">
      <Card title="Dados"><p>Passagens transversais, bueiros e aquedutos de pequena dimensão.</p><div className="form-grid">
      ...
      <Card title="Desenho hidráulico"><HydraulicCanvas title="Drenagem transversal" result={result} mode="culvert" /></Card>

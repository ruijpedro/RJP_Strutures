...
export function DrainagePage() {
  ...
  return <main className="page"><div className="page-title"><h1>Drenagem geral</h1><span className={`status ${velocityClass === 'Elevada' ? 'warning' : 'ok'}`}>{velocityClass}</span></div>
    <div className="workspace"><div className="workspace-main">
      <Card title="Dados"><p>Apoio à análise de drenagem superficial e sub-superficial.</p><div className="form-grid">
      ...
      <Card title="Desenho hidráulico"><HydraulicCanvas title="Drenagem geral" result={result} mode="drain" /></Card>
